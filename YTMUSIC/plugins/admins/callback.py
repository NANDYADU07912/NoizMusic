...
@app.on_callback_query(filters.regex("chatbot_help"))
async def chatbot_help_cb(client, callback_query):
    text = (
        "**🤖 𝐂ʜᴀᴛʙᴏᴛ ʜᴇʟᴘ:**\n\n"
        "Chatbot ko enable ya disable karne ke liye **/chatbot** command bheje.\n\n"
        "Uske baad aapko **Enable** aur **Disable** ke button milenge:\n"
        "✔️ Enable karne pe bot har message ka reply karega.\n"
        "❌ Disable karne pe bot reply dena band kar dega."
    )
    await callback_query.message.edit_text(
        text,
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="ubot_cb")]]
        ),
    )
