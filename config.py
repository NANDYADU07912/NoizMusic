...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME" , "NoizMusicbot")
# --------------------------------------------------------
BOT_NAME = getenv("BOT_NAME" , "˹𝐍ᴏɪᴢ ᴍᴜsɪᴄ˼ ♪ [ ɴᴏ ᴀᴅs ]™")
# ________________________________________________________________________________#
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MesteriousPrivate/NoizMusic",
)
...
API_KEY = getenv("API_KEY")                            # 🔑 API Key from @WTF_WhyMeeh
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://files.catbox.moe/qu02rs.jpg",
)

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://files.catbox.moe/5cir39.jpg",
)

PLAYLIST_IMG_URL = getenv(
    "PLAYLIST_IMG_URL",
    "https://files.catbox.moe/7fcm1c.jpg",
)
